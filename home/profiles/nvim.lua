...
lsp_zero.on_attach(function(client, bufnr)
  ...
  vim.keymap.set('n', '<space>tr', '<cmd>Telescope lsp_references<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>tci', '<cmd>Telescope lsp_incoming_calls<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>tco', '<cmd>Telescope lsp_outgoing_calls<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>tsd', '<cmd>Telescope lsp_document_symbols<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>tsw', '<cmd>Telescope lsp_dynamic_workspace_symbols<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>ti', '<cmd>Telescope lsp_implementations<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>tdd', '<cmd>Telescope lsp_definitions<cr>', {buffer=bufnr})
  vim.keymap.set('n', '<space>tdt', '<cmd>Telescope lsp_type_definitions<cr>', {buffer=bufnr})
end)
